    ...
    private void DrawSettingsProfile(DevSetting.Profile pProfile)
    {
        EditorHelper.BoxVertical(() =>
        {
            if (EditorHelper.HeaderFoldout("General", pProfile.name + "General"))
            {
                ...
                EditorGUILayout.LabelField("- Not Test Settings", EditorStyles.boldLabel);
                pProfile.serverUrl = EditorHelper.TextField(pProfile.serverUrl, "Server URL", 100, 300);
                pProfile.crashEmail = EditorHelper.TextField(pProfile.crashEmail, "Crash Email", 100, 300);
                ...
                pProfile.enableCheat = EditorHelper.Toggle(pProfile.enableCheat, "Enable Cheat", 120, 280);
                pProfile.enableCheatTime = EditorHelper.Toggle(pProfile.enableCheatTime, "Enable Cheat Time", 120, 280);
                EditorGUILayout.LabelField("- Account Test", EditorStyles.boldLabel);
                pProfile.testUserId = EditorHelper.TextField(pProfile.testUserId, "Test User Id", 100, 300);
                pProfile.testUserId = EditorHelper.TextField(pProfile.testUserId, "Test User Name", 100, 300);
                pProfile.testUserId = EditorHelper.TextField(pProfile.testUserId, "Test User Email", 100, 300);
            }
        }, ColorHelper.AppleGreen, true);
