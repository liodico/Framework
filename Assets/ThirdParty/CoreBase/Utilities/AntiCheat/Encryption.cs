...
namespace Utilities.AntiCheat
{
    ...
    public class Encryption : IEncryption
    {
        ...
        {
            var plainTextBytes = XOR(System.Text.Encoding.UTF8.GetBytes(value), encryptKey);
        ...
        public string Decrypt(string value)
        {
            ...
            return System.Text.Encoding.UTF8.GetString(XOR(base64EncodedBytes, encryptKey));
        }
