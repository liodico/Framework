...
namespace Utilities.Demo
{
    ...
    {
        public BuiltInTransformPool(Transform pPrefab, int pInitialCount, Transform pParent, bool pBuildinPrefab, string pName = "", bool pAutoRelocate = true) : base(pPrefab, pInitialCount, pParent, pBuildinPrefab, pName, pAutoRelocate)
        {
        }
    }
    ...
    public class ExamplePoolsManager : MonoBehaviour
    {
        ...
        public void Init()
        {
            ...
            mPoolsContainerTransform = new PoolsContainer<Transform>("Pools", 3, transform);
