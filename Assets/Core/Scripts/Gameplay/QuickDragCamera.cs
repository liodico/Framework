...
{
    [AddComponentMenu("EasyTouch/Quick Drag Camera")]
    public class QuickDragCamera : QuickBase
    {
        ...
        public QuickDragCamera()
        {
            quickActionName = "QuickDragCamera" + System.Guid.NewGuid().ToString().Substring(0, 7);
